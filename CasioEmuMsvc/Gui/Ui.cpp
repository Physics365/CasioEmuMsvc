...
void gui_loop() {
    ...
    ImGui::Begin("Overlay", nullptr, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoDocking |
...
int test_gui(bool *guiCreated, SDL_Window *wnd, SDL_Renderer *rnd) {
    ...
    renderer = rnd;
#else
    window = SDL_CreateWindow("CasioEmuMsvc Debugger", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, 0);
